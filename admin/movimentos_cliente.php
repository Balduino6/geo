...
<body>
  ...
  <!-- <div class="sidebar" id="sidebar">
    ...
    <a href="adm_pedido.php"><i class="bi bi-receipt"></i><span class="menu-text">Pedidos</span></a>
    ...
    <div class="content">
        <div class="container mt-5">
            ...
            <!-- Links para Exportar --> 
            <div class="mb-3">
                <a href="exportar_pdf.php?id=<?php echo $id_cliente; ?>&tipo=<?php echo urlencode($filtro_tipo); ?>&data_inicio=<?php echo urlencode($filtro_data_inicio); ?>&data_fim=<?php echo urlencode($filtro_data_fim); ?>" class="btn btn-danger">Exportar PDF</a>
