<?php 
    ...
    <body>
        <nav class="navbar">
            ...
            <div class="menu">
                <label style="font-size: 20px; color: #2209af;"><b>Cliente:</b><?php  echo  " $nomeUser ". "$sobrenome"; ?></label>
                <a href="logged.php">Página Principal</a>
                <!-- <a href="#">Sobre Nós</a> -->
                <a href="pedido_servico.php">Serviços</a>
                <a href="logout.php"> <img src="./assets/sair.png" alt="" style="width: 20px;">  Sair</a>
        ...
        <section>
            <h2>Serviços</h2>
            <a href="pedido_servico.php" class="ser">
            <div class="servicos">
                <div class="card">
...
<?php else:header('Location: loginCli.php'); endif; ?>  